                ...
                <div class="">
                    ...
                    <div class="flex flex-row space-x-10 items-center justify-center">
                        <div class="flex flex-col items-center justify-center">
                            <p class="text-sm font-light py-2 text-gray-300"> Track your meals </p>
                        ...
                        <div class="flex flex-col items-center justify-center">
                            <p class="text-sm font-light py-2 text-gray-300"> Push notifications </p>
                            <div class="p-5 bg-gray-50 rounded-lg">
                        ...
                        <div class="flex flex-col items-center justify-center">
                            <p class="text-sm font-light py-2 text-gray-300"> Team Challenges </p>
                            <div class="p-5 bg-gray-50 rounded-lg">
                        ...
                        <div class="flex flex-col items-center justify-center">
                            <p class="text-sm font-light py-2 text-gray-300"> Track Workouts </p>
                            <div class="p-5 bg-gray-50 rounded-lg">
...
<!-- 
                <div class="absolute bottom-6 align-bottom">
        ...
        <!-- <div class="flex-col justify-left row-start-2 col-start-1 col-span-3 row-span-2 p-6 h-48 mb-4 border-4 border-gray-225 rounded-full bg-white relative">
            <p class="text-4xl text-gray-800">
                Second <span class="font-bold">Thingy<span>!
            </p>
        </div> -->
