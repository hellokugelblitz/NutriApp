...
public class UserController : ISaveable
{
    ...
    public (Guid, User) CreateUser(string username, string password, int height, double weight, DateTime birthday,
        string name, string bio)
    {
        _userLoginInfo[username] = HashPassword(password);
